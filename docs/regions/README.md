...
_Latest Mod Version:_ `v0.5.1`  
_Latest Tested Game Version:_ `v1.6.1`
_Latest Changelog Entry:_ [v0.5.1](CHANGELOG.md#v051---2026-08-10)
...
- **Preset Regions**: Scripts to obtain region boundaries for the following real-world geographical divisions are provided:
  ...
  - **EE** (Estonia)
    - Maakonnad (Counties) (`ee-maakond`)
    - Omavalitsused / linnaosad (Municipalities / City Districts) (`ee-omavalitsused`)
    - Asustusüksused (Settlement Units) (`ee-asustusuksused`)
  - **UA** (Ukraine)
    - Райони (Raions) (`ua-raions`)
    - Громади / міські райони (Hromadas / City Districts) (`ua-hromadas`)
    - Населені пункти (Settlements) (`ua-naseleni-punkty`)
  - **LV** (Latvia)
    - Novadi un valstspilsētas (Municipalities) (`lv-pasvaldibas`)
    - Apkaimes un pagasti (Neighbourhoods & Parishes) (`lv-apkaimes`)
  - **LT** (Lithuania)
    - Savivaldybės (Municipalities) (`lt-savivaldybes`)
    - Seniūnijos (Elderships) (`lt-seniunijos`)
    - Gyvenamosios vietovės (Localities) (`lt-gyvenvietes`)
