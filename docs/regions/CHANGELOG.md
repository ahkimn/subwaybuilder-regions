...
- Dataset Registry table: map-provided (`railyard`) datasets showed `N/A` for file size, and the wider `railyard` origin label encroached on the file-size column — both fixed.
