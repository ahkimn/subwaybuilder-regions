...
export const DISTANCE_BUCKET_COUNT = 150; // Number of buckets to divide commute distances into display for in chart elements. Anything above the max distance (defined as bucket size * bucket count) will be grouped into an "xkm+" category
