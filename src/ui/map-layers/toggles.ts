...
export function injectRegionToggles(
  panel: HTMLElement,
  datasetsToggleOptions: LayerToggleOptions[],
) {
  ...
  if (!regionSegment) {
    ...
    segmentHeader.className =
      'font-medium mb-1.5 text-xs text-muted-foreground';
